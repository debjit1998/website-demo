...
import { Button, Card, CustomFlowbiteTheme, Popover } from "flowbite-react";
...
const customButtonTheme: CustomFlowbiteTheme["button"] = {
  base: "outline outline-black outline-2 hover:outline-none",
  color: {
...
const popoverContent = (
  <div className="size-[300px] ">
    <div className="absolute bg-shade inset-0 z-[-10]" />
        ...
        <div className="mt-5">
          ...
          >
            <Button
              ...
              className="!bg-white !text-black bg-shade-rounded relative focus:ring-0"
            >
        ...
        <div className="mt-8 flex flex-wrap gap-8">
          {services.map((service) => (
            ...
            >
              ...
              <h2 className="text-[24px] font-[700]">{service.name}</h2>
              <p>{service.description}</p>
              <div className="mt-auto flex gap-2 items-center h-10">
                <p
